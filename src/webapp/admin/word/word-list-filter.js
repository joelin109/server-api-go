...
class WordListFilter extends React.Component {
    constructor() {
        super();
        ...
        let _content = <div className="popup-content">
            ...
            <div className="popup-content-text">
                ...
                <div className="popup-dialog-radio-group">
                    <DropDownMenu value={this.state.selectedLetter} onChange={this._handle_letter_select.bind(this)}>
                        ...
                        <MenuItem value={'B'} primaryText="E" />
            ...
            <div className="popup-content-text">
                <Toggle
                    name="Unregel"
                    label="Unregel:"
                    defaultToggled={this.state.unRegel}
                    onToggle={this._handle_togle_regel.bind(this)}
                />
                <Toggle
                    name="Recommend"
                    label="Recommend:"
